    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ("-created_at",),
                "indexes": [
                    models.Index(fields=["slug"], name="acticles_ar_slug_25a53c_idx"),
                    models.Index(
                        fields=["created_at"], name="acticles_ar_created_917763_idx"
                    ),
                    models.Index(fields=["title"], name="acticles_ar_title_69fddd_idx"),
                    models.Index(
                        fields=["published_at"], name="acticles_ar_publish_6b6b90_idx"
                    ),
                    models.Index(
                        fields=["status", "published_at"],
                        name="acticles_ar_status_99f449_idx",
                    ),
                    models.Index(
                        fields=["review_status"], name="acticles_ar_review__b4f48c_idx"
                    ),
                    models.Index(
                        fields=["is_deleted"], name="acticles_ar_is_dele_8e72eb_idx"
                    ),
                ],
            },
        ),
